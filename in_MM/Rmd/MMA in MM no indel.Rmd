...
`r nrow(ch_wide)` total patients - `r nrow(ch_wide %>% filter(CH_status_no_indel == "CH"))` CH patients, `r nrow(ch_wide %>% filter(CH_status_no_indel == "No CH"))` no CH, 33? Ukn      - 44 CH but with No damages genes + 579 no CH = 623 patients
```{r}
ch_wide %>%
...
`r nrow(ch_wide)` total patients - `r nrow(ch_wide %>% filter(CH_status_no_indel == "CH"))` patients CH, 579 no CH, 33 Ukn      - 36 CH but with No TD genes + 579 no CH = 615 patients
```{r}
ch_wide %>%
