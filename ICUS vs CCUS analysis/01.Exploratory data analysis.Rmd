...
ggsurvplot(survfit(Surv(os_time, os_event) ~ mma_cat, 
                   data=surv_data),
           title = "OS Analysis",
...
tbl1 <- surv_data %>% 
  ...
  bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") %>%
  bold_labels() %>% italicize_levels() %>% 
  modify_spanning_header(everything() ~ paste("Association with MMA in female data - categorical MMA"))
tbl2 <- coxph(Surv(time = surv_data$os_time, 
             event = surv_data$os_event) ~ 
               group + mma_cat + age + bmi + CrCl_interpretation + baseline_b12_serum, 
             data =  surv_data) %>%
...
tbl1 <- surv_data %>% 
  ...
  bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") %>%
  bold_labels() %>% italicize_levels() %>% 
  modify_spanning_header(everything() ~ paste("Association with MMA in ICUS data - continuous MMA"))
tbl2 <- coxph(Surv(time = surv_data$os_time, 
             event = surv_data$os_event) ~ 
               sex + mma_um + age + bmi + CrCl_interpretation + baseline_b12_serum, 
             data =  surv_data) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05)
tbl_merge(list(tbl1, tbl2), tab_spanner = c("**Univariable**", "**Multivariable**"))
...
tbl1 <- surv_data %>% 
  ...
  bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") %>%
  bold_labels() %>% italicize_levels() %>% 
  modify_spanning_header(everything() ~ paste("Association with MMA in ICUS data - categorical MMA"))
tbl2 <- coxph(Surv(time = surv_data$os_time, 
             event = surv_data$os_event) ~ 
               sex + mma_cat + age + bmi + CrCl_interpretation + baseline_b12_serum, 
             data =  surv_data) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05)
tbl_merge(list(tbl1, tbl2), tab_spanner = c("**Univariable**", "**Multivariable**"))
...
tbl1 <- surv_data %>% 
  ...
  bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") %>%
  bold_labels() %>% italicize_levels() %>% 
  modify_spanning_header(everything() ~ paste("Association with succinate in ICUS data"))
tbl2 <- coxph(Surv(time = surv_data$os_time, 
             event = surv_data$os_event) ~ 
               sex + succinate_ug_m_l + age + bmi + CrCl_interpretation + baseline_b12_serum, 
             data =  surv_data) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05)
tbl_merge(list(tbl1, tbl2), tab_spanner = c("**Univariable**", "**Multivariable**"))
```
...
tbl1 <- surv_data %>% 
  ...
  bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") %>%
  bold_labels() %>% italicize_levels() %>% 
  modify_spanning_header(everything() ~ paste("Association with MMA in CCUS data - continuous MMA"))
tbl2 <- coxph(Surv(time = surv_data$os_time, 
             event = surv_data$os_event) ~ 
               sex + mma_um + age + bmi + CrCl_interpretation + baseline_b12_serum, 
             data =  surv_data) %>%
...
tbl1 <- surv_data %>% 
  ...
  bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") %>%
  bold_labels() %>% italicize_levels() %>% 
  modify_spanning_header(everything() ~ paste("Association with MMA in CCUS data - categorical MMA"))
tbl2 <- coxph(Surv(time = surv_data$os_time, 
             event = surv_data$os_event) ~ 
               sex + mma_cat + age + bmi + CrCl_interpretation + baseline_b12_serum, 
             data =  surv_data) %>%
...
tbl1 <- surv_data %>% 
  ...
  bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") %>%
  bold_labels() %>% italicize_levels() %>% 
  modify_spanning_header(everything() ~ paste("Association with succinate in CCUS data"))
tbl2 <- coxph(Surv(time = surv_data$os_time, 
             event = surv_data$os_event) ~ 
               sex + succinate_ug_m_l + age + bmi + CrCl_interpretation + baseline_b12_serum, 
             data =  surv_data) %>%
